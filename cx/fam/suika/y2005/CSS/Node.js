...
cx.fam.suika.y2005.CSS.Node.Node.prototype.CSS_VALUE_NODE                = 105;
...
cx.fam.suika.y2005.CSS.Node.StyleSheet = function () {
  ...
  this.cssNodeType = this.CSS_STYLE_SHEET_NODE;
...
cx.fam.suika.y2005.CSS.Node.AtRule = function (namespaceURI, localName) {
  cx.fam.suika.y2005.CSS.Node.AtRule._superclass.apply (this, arguments);
  this.ruleNamespaceURI = namespaceURI;
  this.ruleLocalName = localName;
};
...
cx.fam.suika.y2005.CSS.Node.FontFaceRule = function () {
  cx.fam.suika.y2005.CSS.Node.FontFaceRule._superclass.apply (this, arguments);
  this.style = new cx.fam.suika.y2005.CSS.Node.StyleDeclaration ();
};
...
cx.fam.suika.y2005.CSS.Node.PageRule = function () {
  cx.fam.suika.y2005.CSS.Node.PageRule._superclass.apply (this, arguments);
};
...
cx.fam.suika.y2005.CSS.Node.ImportRule = function (hrefArg, mediaArg) {
  cx.fam.suika.y2005.CSS.Node.ImportRule._superclass.apply (this, arguments);
  this.href = hrefArg;
  if (mediaArg) {
    this.media = mediaArg;
  } else {
...
cx.fam.suika.y2005.CSS.Node.CharsetRule = function (encodingArg) {
  cx.fam.suika.y2005.CSS.Node.CharsetRule._superclass.apply (this, arguments);
...
*/
cx.fam.suika.y2005.CSS.Node.UnknownRule = function () {
  cx.fam.suika.y2005.CSS.Node.UnknownRule._superclass.apply (this, arguments);
};
...
cx.fam.suika.y2005.CSS.Node.RuleSet = function () {
  ...
  this.cssNodeType = this.CSS_RULE_SET_NODE;
  this.style = new cx.fam.suika.y2005.CSS.Node.StyleDeclaration ();
};
...
cx.fam.suika.y2005.CSS.Node.Declaration = function () {
  ...
  this.cssNodeType = this.CSS_EMPTY_DECLARATION_NODE;
};
...
cx.fam.suika.y2005.CSS.Node.PropertyDeclaration = function (nsURI, lname) {
  ...
  this.cssNodeType = this.CSS_PROPERTY_DECLARATION_NODE;
...
/* Revision: $Date: 2005/11/01 10:40:48 $ */
